...
""" + select({
        "@//bazel:brpc_with_sse42": """-e 's/ HAVE_SSE42/ HAVE_SSE42 1/' \
""",
        "//conditions:default": """-e 's/ HAVE_SSE42/ HAVE_SSE42 0/' \
""",
    }) + select({
        "@//bazel:brpc_with_glog": """-e 's/ CRC32C_TESTS_BUILT_WITH_GLOG/ CRC32C_TESTS_BUILT_WITH_GLOG 1/' \
""",
...
cc_test(
    ...
    deps = [
        ...
        "@//bazel:brpc_with_glog": ["@com_github_glog_glog//:glog"],
        "//conditions:default": [],
    }),
)
