...
cc_library(
    name = "dwarf",
    srcs = glob(["src/lib/libdwarf/*.c"]),
    hdrs = ["config.h"] + glob(["src/lib/libdwarf/*.h"]),
    copts = [
        "-g",
        "-O2",
        "-march=native",
...
cc_library(
    name = "dwarfp",
    srcs = glob(["src/lib/libdwarfp/*.c"]),
    hdrs = glob(["src/lib/libdwarfp/*.h"]),
    additional_compiler_inputs = [":config_h"],
    copts = [
        "-g",
        "-O2",
        "-march=native",
        #"-isystem $(GENDIR)",
        "-isystem $(location :config_h)",
    ],
    includes = [
        #"$(directory :config_h)",
        "src/lib/libdwarfp",
