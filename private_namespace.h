...
#define background_thread_wakeup_early \
  JEMALLOC_N(background_thread_wakeup_early)
...
#define ehooks_default_purge_forced_impl \
  JEMALLOC_N(ehooks_default_purge_forced_impl)
...
#define pa_shard_time_until_deferred_work \
  JEMALLOC_N(pa_shard_time_until_deferred_work)
...
#define peak_alloc_postponed_event_wait \
  JEMALLOC_N(peak_alloc_postponed_event_wait)
...
#define prof_recent_alloc_edata_get_no_lock_test \
  JEMALLOC_N(prof_recent_alloc_edata_get_no_lock_test)
#define prof_recent_alloc_list JEMALLOC_N(prof_recent_alloc_list)
#define prof_recent_alloc_max_ctl_read \
  JEMALLOC_N(prof_recent_alloc_max_ctl_read)
#define prof_recent_alloc_max_ctl_write \
  JEMALLOC_N(prof_recent_alloc_max_ctl_write)
...
#define safety_check_fail_sized_dealloc \
  JEMALLOC_N(safety_check_fail_sized_dealloc)
