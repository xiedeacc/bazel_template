...
using grpc::Status;
using bazel_template::common::TboxConfigPtr;
using bazel_template::context::GrpcContext;
using bazel_template::context::ScopeDecrementContextCounter;
using bazel_template::server::ServerStatusRequest;
using bazel_template::server::ServerStatusResponse;
using bazel_template::util::CommonUtil;
using bazel_template::util::ConfigUtil;
using bazel_template::util::GCEntry;
...
void GrpcServer::ScanList() {
  LOG(INFO) << "ScanList";
  bazel_template::context::GrpcContext* grpc_context = nullptr;
  bazel_template::context::GrpcContext* fast_fail_grpc_context = nullptr;
...
void GrpcServer::DoServerStatus(
    const bazel_template::server::ServerStatusRequest* request,
    bazel_template::server::ServerStatusResponse* response,
    bazel_template::context::GrpcContext* grpc_context) {
