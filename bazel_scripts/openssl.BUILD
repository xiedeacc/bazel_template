...
load("@bazel_problem//bazel_scripts:common.bzl", "run_command")
#genrule(
...
genrule(
    name = "print_config",
    srcs = ["configdata.pm"],
    outs = ["config_output.txt"],
    cmd = "perl configdata.pm --dump > $(OUTS)",
)
...
cc_library(
    ...
    includes = [
        ...
        "external/openssl/apps/include",
        "external/openssl/crypto",
        "external/openssl/engines",
        "external/openssl/include",
        "external/openssl/providers",
...
# Optionally add cc_binary targets if needed
