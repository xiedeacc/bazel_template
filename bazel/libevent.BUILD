...
template_rule(
    ...
    substitutions = select({
        ...
        "@platforms//os:windows": {
            ...
            "#define EVENT__HAVE_LIBZ 1": "/* #undef EVENT__HAVE_LIBZ */",
            ...
            "#define EVENT__HAVE_OPENSSL 1": "/* #undef EVENT__HAVE_OPENSSL */",
            "#define EVENT__HAVE_OPENSSL_SSL_H 1": "/* #undef EVENT__HAVE_OPENSSL_SSL_H */",
            ...
            "#define EVENT__HAVE_ZLIB_H 1": "/* #undef EVENT__HAVE_ZLIB_H */",
...
template_rule(
    ...
    substitutions = select({
        "@platforms//os:osx": {
            "#define _GNU_SOURCE 1": "/* #undef _GNU_SOURCE */",
        },
        "@platforms//os:windows": {
            "/* #undef _FILE_OFFSET_BITS */": "#define _FILE_OFFSET_BITS 64",
        },
